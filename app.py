...
if menu == "Dataset":
    ...
    if df_imputed is not None:
        ...
        cleaned_data_6 = replace_outliers_with_interpolation(cleaned_data_5.values)
        cleaned_data_7 = replace_outliers_with_interpolation(cleaned_data_6.values)
        cleaned_data_8 = replace_outliers_with_interpolation(cleaned_data_7.values)
        cleaned_data_9 = replace_outliers_with_interpolation(cleaned_data_8.values)
        cleaned_data_10 = replace_outliers_with_interpolation(cleaned_data_9.values)
